...
append using "$data_dir/WVS-EVS/wvs1981_2008_v20090914.dta", gen(study)
replace study = 1 - study

gen year=s020

decode s003, gen(countryname)
...
replace countryname = "Germany" if countryname == "Germany West"
replace countryname = "United Kingdom" if countryname == "Great Britain"
replace countryname = "Hong Kong SAR, China" if countryname == "Hong Kong Special Administrative Region Of China"
...
replace countryname = "Macedonia, FYR" if countryname == "Macedonia, Republic Of"
