...
******************************************************************
******************************************************************
capture rm "outreg_A/macro_growth_fate.tex" 
capture rm "outreg_A/macro_growth_fate.rtf" 
eststo clear
global controls ""
eststo: reg shapefateyrself_hat growth $controls, r
	estadd local N1 = "`e(N)'"
...
eststo: reg shapefateyrself_hat growth $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_growth_fate.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Locus of Control and Growth)  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")

capture rm "outreg_A/macro_growth_risk.tex" 
capture rm "outreg_A/macro_growth_risk.rtf" 
eststo clear
global controls ""
eststo: reg risktaking_hat growth $controls, r
	estadd local N1 = "`e(N)'"
local controls = "godimportant_hat socialst urbpop95 wardum pop95 "
eststo: reg risktaking_hat growth `controls', r
	estadd local N1 = "`e(N)'"
...
eststo: reg risktaking_hat growth $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_growth_risk.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Risktaking and Growth)  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")

capture rm "outreg_A/macro_growth_work.tex" 
capture rm "outreg_A/macro_growth_work.rtf" 
eststo clear
global controls ""
eststo: reg wouldntwork_hat growth $controls, r
	estadd local N1 = "`e(N)'"
...
eststo: reg wouldntwork_hat growth $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_growth_work.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Intrinsic motivation and Growth (1))  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")
...
capture rm "outreg_A/macro_growth_trust.tex" 
capture rm "outreg_A/macro_growth_trust.rtf" 
eststo clear
global controls ""
eststo: reg trustmeetfirsttime_hat growth $controls, r
	estadd local N1 = "`e(N)'"
local controls = "godimportant_hat socialst urbpop95 wardum pop95 "
eststo: reg trustmeetfirsttime_hat growth `controls', r
	estadd local N1 = "`e(N)'"
...
eststo: reg trustmeetfirsttime_hat growth $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_growth_trust.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Trust and Growth)  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")

capture rm "outreg_A/macro_growth_daytoday.tex" 
capture rm "outreg_A/macro_growth_daytoday.rtf" 
eststo clear
global controls ""
eststo: reg livedaytoday_hat growth $controls, r
	estadd local N1 = "`e(N)'"
local controls = "godimportant_hat socialst urbpop95  pop95 "
eststo: reg livedaytoday_hat growth `controls', r
	estadd local N1 = "`e(N)'"
...
eststo: reg livedaytoday_hat growth $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_growth_daytoday.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Short-sightedness and Growth)  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")
/*note: troppop omitted because of collinearity
note: south omitted because of collinearity
note: wardum omitted because of collinearity
note: safri omitted because of collinearity
...
capture rm "outreg_A/macro_growth_intrinsic.tex" 
capture rm "outreg_A/macro_growth_intrinsic.rtf" 
eststo clear
global controls ""
eststo: reg intrinsic_hat growth $controls, r
	estadd local N1 = "`e(N)'"
local controls = "godimportant_hat socialst urbpop95 pop95 "
eststo: reg intrinsic_hat growth `controls', r
	estadd local N1 = "`e(N)'"
...
eststo: reg intrinsic_hat growth $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_growth_intrinsic.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Intrinsic motivation and Growth (2))  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")
/*
note: troppop omitted because of collinearity
note: south omitted because of collinearity
note: wardum omitted because of collinearity
...
capture rm "outreg_A/macro_growth_lonely.tex" 
capture rm "outreg_A/macro_growth_lonely.rtf" 
eststo clear
global controls ""
eststo: reg lonely_hat  growth $controls, r
	estadd local N1 = "`e(N)'"
...
eststo: reg lonely_hat  growth $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_growth_lonely.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Loneliness and Growth)  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")
...
capture rm "outreg_A/macro_growth_meaning.tex" 
capture rm "outreg_A/macro_growth_meaning.rtf" 
eststo clear
global controls ""
eststo: reg lifemeaningless_hat  growth $controls, r
	estadd local N1 = "`e(N)'"
local controls = "godimportant_hat  urbpop95  pop95 "
eststo: reg lifemeaningless_hat  growth `controls', r
	estadd local N1 = "`e(N)'"
...
eststo: reg lifemeaningless_hat  growth $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_growth_meaning.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Meaninglessness and Growth)  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")
/*note: Landlocked omitted because of collinearity
note: troppop omitted because of collinearity
note: south omitted because of collinearity
note: socialst omitted because of collinearity
...
capture rm "outreg_A/macro_growth_helpfam.tex" 
capture rm "outreg_A/macro_growth_helpfam.rtf" 
eststo clear
global controls ""
eststo: reg helpfamily_hat growth $controls, r
	estadd local N1 = "`e(N)'"
local controls = "godimportant_hat socialst urbpop95  pop95 "
eststo: reg helpfamily_hat  growth `controls', r
	estadd local N1 = "`e(N)'"
...
eststo: reg helpfamily_hat  growth $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_growth_helpfam.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Altruism and Growth)  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")
