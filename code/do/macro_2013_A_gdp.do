...
******************************************************************
******************************************************************
capture rm "outreg_A/macro_gdp_fate.tex" 
capture rm "outreg_A/macro_gdp_fate.rtf" 
eststo clear
global controls ""
eststo: reg shapefateyrself_hat lgdp $controls, r
	estadd local N1 = "`e(N)'"
...
eststo: reg shapefateyrself_hat lgdp $controls, r
	estadd local N1 = "`e(N)'"
************** JOHANNES TOOK OUT THE TITLE HERE; this makes it possible to place them in floats in LyX ***********************
	esttab using "outreg_A/macro_gdp_fate.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")

capture rm "outreg_A/macro_gdp_risk.tex" 
capture rm "outreg_A/macro_gdp_risk.rtf" 
eststo clear
global controls ""
eststo: reg risktaking_hat lgdp $controls, r
	estadd local N1 = "`e(N)'"
local controls = "godimportant_hat socialst urbpop95 wardum pop95 "
eststo: reg risktaking_hat lgdp `controls', r
	estadd local N1 = "`e(N)'"
...
eststo: reg risktaking_hat lgdp $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_gdp_risk.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Risktaking and Income)  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")

capture rm "outreg_A/macro_gdp_work.tex" 
capture rm "outreg_A/macro_gdp_work.rtf" 
eststo clear
global controls ""
eststo: reg wouldntwork_hat lgdp $controls, r
	estadd local N1 = "`e(N)'"
...
eststo: reg wouldntwork_hat lgdp $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_gdp_work.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Intrinsic motivation and Income (1))  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")
...
capture rm "outreg_A/macro_gdp_trust.tex" 
capture rm "outreg_A/macro_gdp_trust.rtf" 
eststo clear
global controls ""
eststo: reg trustmeetfirsttime_hat lgdp $controls, r
	estadd local N1 = "`e(N)'"
local controls = "godimportant_hat socialst urbpop95 wardum pop95 "
eststo: reg trustmeetfirsttime_hat lgdp `controls', r
	estadd local N1 = "`e(N)'"
...
eststo: reg trustmeetfirsttime_hat lgdp $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_gdp_trust.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Trust and Income)  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")

capture rm "outreg_A/macro_gdp_daytoday.tex" 
capture rm "outreg_A/macro_gdp_daytoday.rtf" 
eststo clear
global controls ""
eststo: reg livedaytoday_hat lgdp $controls, r
	estadd local N1 = "`e(N)'"
local controls = "godimportant_hat socialst urbpop95  pop95 "
eststo: reg livedaytoday_hat lgdp `controls', r
	estadd local N1 = "`e(N)'"
...
eststo: reg livedaytoday_hat lgdp $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_gdp_daytoday.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Short-sightedness and Income)  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")
/*note: troppop omitted because of collinearity
note: south omitted because of collinearity
note: wardum omitted because of collinearity
note: safri omitted because of collinearity
...
capture rm "outreg_A/macro_gdp_intrinsic.tex" 
capture rm "outreg_A/macro_gdp_intrinsic.rtf" 
eststo clear
global controls ""
eststo: reg intrinsic_hat lgdp $controls, r
	estadd local N1 = "`e(N)'"
local controls = "godimportant_hat socialst urbpop95 pop95 "
eststo: reg intrinsic_hat lgdp `controls', r
	estadd local N1 = "`e(N)'"
...
eststo: reg intrinsic_hat lgdp $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_gdp_intrinsic.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Intrinsic motivation and Income (2))  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")
/*
note: troppop omitted because of collinearity
note: south omitted because of collinearity
note: wardum omitted because of collinearity
...
capture rm "outreg_A/macro_gdp_lonely.tex" 
capture rm "outreg_A/macro_gdp_lonely.rtf" 
eststo clear
global controls ""
eststo: reg lonely_hat  lgdp $controls, r
	estadd local N1 = "`e(N)'"
...
eststo: reg lonely_hat  lgdp $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_gdp_lonely.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Loneliness and Income)  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")
...
capture rm "outreg_A/macro_gdp_meaning.tex" 
capture rm "outreg_A/macro_gdp_meaning.rtf" 
eststo clear
global controls ""
eststo: reg lifemeaningless_hat  lgdp $controls, r
	estadd local N1 = "`e(N)'"
local controls = "godimportant_hat  urbpop95  pop95 "
eststo: reg lifemeaningless_hat  lgdp `controls', r
	estadd local N1 = "`e(N)'"
...
eststo: reg lifemeaningless_hat  lgdp $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_gdp_meaning.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Meaninglessness and Income)  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")
/*note: Landlocked omitted because of collinearity
note: troppop omitted because of collinearity
note: south omitted because of collinearity
note: socialst omitted because of collinearity
...
capture rm "outreg_A/macro_gdp_helpfam.tex" 
capture rm "outreg_A/macro_gdp_helpfam.rtf" 
eststo clear
global controls ""
eststo: reg helpfamily_hat lgdp $controls, r
	estadd local N1 = "`e(N)'"
local controls = "godimportant_hat socialst urbpop95  pop95 "
eststo: reg helpfamily_hat  lgdp `controls', r
	estadd local N1 = "`e(N)'"
...
eststo: reg helpfamily_hat  lgdp $controls, r
	estadd local N1 = "`e(N)'"
esttab using "outreg_A/macro_gdp_helpfam.tex", replace width(17cm) wrap nogaps label se star(* 0.10 ** 0.05 *** 0.01) nonotes title(Altruism and Income)  stats(N1, labels("Obs.")) addnotes("Robust standard errors in parentheses. * p < 0.10, ** p < 0:05, *** p < 0.01.")
